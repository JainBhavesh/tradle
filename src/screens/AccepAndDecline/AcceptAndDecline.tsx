  ...
  return (
    <BaseLayout style={style.main}>
      ...
      <Text preset="h3" style={style.desc}>
        Buying and Selling High & Low-Volume Commodities Globally. Tradal's
        Advanced Technology will Enable us to Reduce the Previous 3-4 Months to
        a Mere 45 minutes.
      </Text>
      <View style={style.row}>
        ...
        <Text preset="h3" style={style.termConText}>
      ...
      <View style={style.btnContainer}>
        <Button
          ...
          title={'Decline'}
          titleStyle={{ color: color.backgroundColor }}
          buttonContainerStyle={style.buttonContainerStyle}
        />
        <Button
          onPress={() => {
            navigation.navigate('AUTHENTICATE', { roll: roll });
          }}
          title={'Accept'}
