  ...
  const renderTab = (tabName: string, index: number) => (
    <TouchableOpacity
      style={[
        styles.tab,
        {
          width: tabName == 'Technology' ? scaleWidth(100) : scaleWidth(70),
          backgroundColor:
            activeTab === tabName
  ...
  return (
    <BaseLayout style={styles.main}>
      <View style={styles.container}>
        <View style={{ width: '50%', justifyContent: 'space-between' }}>
          <View style={{}}>
            ...
            <Text preset="h1" color="white" style={{}}>
              {'Animal Parts'}
            </Text>
          </View>
          <View
          ...
          <View
            ...
            <View
              ...
              <Image
                ...
                tintColor={color.theme5.primaryColor}
                resizeMode="contain"
                style={{
                  height: scaleHeight(15),
                  width: scaleWidth(15),
            ...
            <Text preset="h5" color="#d2ebf6" style={{ alignSelf: 'center' }}>
              Exchange
            </Text>
          </View>
        </View>
      ...
      <View>
        ...
        <Text preset="h3" style={{ paddingHorizontal: scaleWidth(10) }}>
          About 11,130,000 result fot{' '}
          <Text color={color.theme5.primaryColor} preset="h3">
            Animal Feed
          </Text>
        </Text>
        <ScrollView
          style={{ paddingHorizontal: scaleWidth(6), height: scaleHeight(260) }}
          scrollEnabled>
          <TouchableOpacity
            activeOpacity={0.9}
            onPress={() => {
            ...
            <View style={{ paddingHorizontal: scaleWidth(10), paddingTop: 8 }}>
              <Text preset="h3" color={color.theme5.primaryColor}>
                Check exchange pricing
              </Text>
